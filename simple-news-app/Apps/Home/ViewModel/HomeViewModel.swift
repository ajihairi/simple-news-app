...
class HomeViewModel {
    ...
    func generateSomeCats(completion: @escaping() -> ()) {
        ...
        let cat4 = HomeModel(cat_id: 3, cat_name: "Entertainment", cat_Img: R.image.entertainment_img()!)
        let cat5 = HomeModel(cat_id: 4, cat_name: "General", cat_Img: R.image.music_img()!)
        let cat6 = HomeModel(cat_id: 5, cat_name: "Technology", cat_Img: R.image.tech_img()!)
        let cat7 = HomeModel(cat_id: 6, cat_name: "Science", cat_Img: R.image.politics_img()!)
